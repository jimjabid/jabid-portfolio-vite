...
void main() {
  ...
  `,document.head.appendChild(n),()=>{e&&e.destroy(),n.remove()}}Ze.registerPlugin(ze);function _E(){const r="ontouchstart"in window||navigator.maxTouchPoints>0,e=document.querySelector(".contact > .title-container"),t=document.querySelectorAll(" .contact-title");Ze.from(t,{duration:r?1.5:3.5,xPercent:r?-50:-100,opacity:0,ease:"power3.out",scrollTrigger:{trigger:e,start:"top 80%",end:"top 20%",scrub:r?1:!0,once:r}});const n=document.querySelector(".contact-container"),i=n.querySelectorAll(":scope > *");Ze.from(i,{duration:r?1.5:3.5,yPercent:50,opacity:0,ease:"power3.out",stagger:r?.1:.25,scrollTrigger:{trigger:n,start:"top 80%",end:"top 20%",scrub:r?1:!0,once:r}})}function vE(){const r=document.querySelectorAll("img[data-src]"),e=new IntersectionObserver((t,n)=>{t.forEach(i=>{if(i.isIntersecting){const s=i.target;s.src=s.dataset.src,s.onload=()=>s.classList.remove("lazy"),n.unobserve(s)}})});r.forEach(t=>e.observe(t))}function xE(r){const e=document.querySelector("#tech-container"),t=new IntersectionObserver(n=>{n.forEach(i=>{i.isIntersecting&&(r(),t.unobserve(i.target))})},{threshold:.1});e&&t.observe(e)}Ze.registerPlugin(ze);function SE(){if(!document.querySelector(".tech-container")){console.error("Tech container not found");return}requestAnimationFrame(()=>{bp()})}function Ef(){const r="ontouchstart"in window||navigator.maxTouchPoints>0,e=/iPhone|iPad|iPod/i.test(navigator.userAgent)&&navigator.maxTouchPoints>0;ze.config({ignoreMobileResize:!0,autoRefreshEvents:"visibilitychange,DOMContentLoaded,load"}),(r||e)&&ze.defaults({scrub:!0,ease:"power3.out",preventOverlaps:!0,fastScrollEnd:!0,start:"top 80%",end:"top 20%",markers:!1,toggleActions:"play none none reverse"}),vE(),dg();const t=gg(),n=new CM({dom:document.querySelector("#myThreeJsCanvas")});window.addEventListener("resize",()=>{n&&n.resize()}),xE(()=>{bp()}),RM(),LM(),gE(),_E(),setTimeout(SE,100),window.addEventListener("unload",()=>{t&&t(),n&&n.dispose()}),(r||e)&&document.addEventListener("touchmove",i=>{i.isTrusted},{passive:!0})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ef):Ef();
