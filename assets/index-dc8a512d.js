...
void main() {
  ...
  `,document.head.appendChild(t),()=>{r&&r.destroy(),t.remove()}}Ze.registerPlugin(ze);function _E(){const r=document.querySelector(".contact > .title-container"),e=document.querySelectorAll(" .contact-title");Ze.from(e,{duration:3.5,xPercent:-100,opacity:0,ease:"powe3.out",stagger:.25,scrollTrigger:{trigger:r,start:"top 70%",end:"top 60%",scrub:!0}});const t=document.querySelector(".contact-container"),n=t.querySelectorAll(":scope > *");Ze.from(n,{duration:3.5,yPercent:100,opacity:0,ease:"powe3.out",stagger:.25,scrollTrigger:{trigger:t,start:"top 70%",end:"top 50%",scrub:!0}})}function vE(){const r=document.querySelectorAll("img[data-src]"),e=new IntersectionObserver((t,n)=>{t.forEach(i=>{if(i.isIntersecting){const s=i.target;s.src=s.dataset.src,s.onload=()=>s.classList.remove("lazy"),n.unobserve(s)}})});r.forEach(t=>e.observe(t))}function xE(r){const e=document.querySelector("#tech-container"),t=new IntersectionObserver(n=>{n.forEach(i=>{i.isIntersecting&&(r(),t.unobserve(i.target))})},{threshold:.1});e&&t.observe(e)}Ze.registerPlugin(ze);function SE(){if(!document.querySelector(".tech-container")){console.error("Tech container not found");return}requestAnimationFrame(()=>{bp()})}function Ef(){const r=/iPhone|iPad|iPod/i.test(navigator.userAgent)&&navigator.maxTouchPoints&&navigator.maxTouchPoints>1;ze.config({limitCallbacks:!0,ignoreMobileResize:!0,autoRefreshEvents:"visibilitychange,DOMContentLoaded,load"}),r?(ze.normalizeScroll(!1),Ze.config({force3D:!1,autoSleep:60,nullTargetWarn:!1})):ze.normalizeScroll(!0),vE(),dg();const e=gg(),t=new CM({dom:document.querySelector("#myThreeJsCanvas")});window.addEventListener("resize",()=>{t&&t.resize()}),xE(()=>{bp()}),RM(),LM(),gE(),_E(),setTimeout(SE,100),window.addEventListener("unload",()=>{e&&e(),t&&t.dispose()})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ef):Ef();
