...
void main() {
  ...
  `,document.head.appendChild(t),()=>{r&&r.destroy(),t.remove()}}Je.registerPlugin(Be);function _E(){const r=document.querySelector(".contact > .title-container"),e=document.querySelectorAll(" .contact-title");Je.from(e,{duration:3.5,xPercent:-100,opacity:0,ease:"powe3.out",stagger:.25,scrollTrigger:{trigger:r,start:"top 70%",end:"top 60%",scrub:!0}});const t=document.querySelector(".contact-container"),n=t.querySelectorAll(":scope > *");Je.from(n,{duration:3.5,yPercent:100,opacity:0,ease:"powe3.out",stagger:.25,scrollTrigger:{trigger:t,start:"top 70%",end:"top 50%",scrub:!0}})}function vE(){const r=document.querySelectorAll("img[data-src]"),e=new IntersectionObserver((t,n)=>{t.forEach(i=>{if(i.isIntersecting){const s=i.target;s.src=s.dataset.src,s.onload=()=>s.classList.remove("lazy"),n.unobserve(s)}})});r.forEach(t=>e.observe(t))}function xE(r){const e=document.querySelector("#tech-container"),t=new IntersectionObserver(n=>{n.forEach(i=>{i.isIntersecting&&(r(),t.unobserve(i.target))})},{threshold:.1});e&&t.observe(e)}Je.registerPlugin(Be);function SE(){if(!document.querySelector(".tech-container")){console.error("Tech container not found");return}requestAnimationFrame(()=>{bp()})}function Ef(){const r="ontouchstart"in window||navigator.maxTouchPoints>0,e=/iPhone|iPad|iPod/i.test(navigator.userAgent)&&navigator.maxTouchPoints>0;Be.config({ignoreMobileResize:!0,autoRefreshEvents:"visibilitychange,DOMContentLoaded,load",normalizeScroll:!r&&!e}),(r||e)&&Be.defaults({scrub:1,ease:"power3.out",preventOverlaps:!0,fastScrollEnd:!0}),vE(),dg();const t=gg(),n=new CM({dom:document.querySelector("#myThreeJsCanvas")});window.addEventListener("resize",()=>{n&&n.resize()}),xE(()=>{bp()}),RM(),LM(),gE(),_E(),setTimeout(SE,100),window.addEventListener("unload",()=>{t&&t(),n&&n.dispose()}),(r||e)&&document.addEventListener("touchmove",i=>{i.isTrusted},{passive:!0})}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",Ef):Ef();
